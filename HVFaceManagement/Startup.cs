...
namespace HVFaceManagement
{
    public class Startup
    {
        ...
        {
            services.AddDbContext<GTRDBContext>(options => options.UseSqlServer(Configuration.GetConnectionString("DefaultConnection")));
            services.AddDbContext<HikVisonFDContext>(options => options.UseSqlServer(Configuration.GetConnectionString("DefaultConnection")));
